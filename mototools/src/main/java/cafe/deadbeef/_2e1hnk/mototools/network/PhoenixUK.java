...
public class PhoenixUK extends AbstractNetwork {
	public PhoenixUK(RadioProfile radioProfile) {
		...
		this.addTalkgroup(1, 81, "UK UA2", false, false, false);
		this.addTalkgroup(1, 82, "UK UA3", false, false, false);
		this.addTalkgroup(1, 83, "UK UA4", false, false, false);
		this.addTalkgroup(1, 84, "UK UA5", false, false, false);
		...
		this.addTalkgroup(2, 801, "SE Eng", false, true, false, true);
		this.addTalkgroup(2, 810, "SW Eng", false, true, false, true);
		//this.addTalkgroup(2, 820, "NW Eng", false, true, false, true);
		this.addTalkgroup(2, 830, "Midl Eng", false, true, false, true);
		this.addTalkgroup(2, 840, "East Eng", false, true, false, true);
		//this.addTalkgroup(2, 850, "Scotland", false, true, false, true);
		//this.addTalkgroup(2, 860, "NE Eng", false, true, false, true);
		this.addTalkgroup(2, 870, "Wales/Borders", false, true, false, true);
		//this.addTalkgroup(2, 880, "N Ireland", false, false, false, true);
		this.addTalkgroup(2, 9990, "Echo Test", false, false, false);
		// this.addTalkgroup(1, 260, "UK-Poland UA", false, false, false);
